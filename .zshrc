source "$HOME/.local/bin/my-zsh-functions.sh"
...
# fix ssh issue: 'xterm-ghostty': unknown terminal type.
...
source_if_exists "$HOME/scripts/awsume-aliases.sh"
source_if_exists "$HOME/scripts/cryptor_aliases.sh"
